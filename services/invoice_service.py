...
class InvoiceService:
    ...
    def save_standard_invoice(self, company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products):
        return self.db.save_standard_invoice(company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products)

    def update_standard_invoice(self, invoice_id, company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products):
        return self.db.update_standard_invoice(invoice_id, company_name, stat, nif, address, date_issue, date_result, product_ref, responsable, total, selected_products)
